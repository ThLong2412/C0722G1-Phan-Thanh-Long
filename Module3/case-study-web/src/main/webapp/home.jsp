        ...
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0" >
                    ...
                    <div>
                        <a class="btn btn-primary" href="/employee?action=employee" role="button">Employee</a>
                    </div>
                    <div>
                        <a class="btn btn-primary" href="/customer?action=customer" role="button">Customer</a>
                    </div>
                    <div>
                        <a class="btn btn-primary" href="/facility?action=facility" role="button">Service</a>
                    </div>
                    <div>
                        <a class="btn btn-primary" href="/contract?action=contract" role="button">Contract</a>
                    </div>
                </ul>
                <form class="d-flex">
    ...
    <div class=" col-lg-2 " style=" margin: 0; padding: 0;">
        <div class="list-group">
            <a href="https://furamavietnam.com/vi/furama-special-offers/" class="list-group-item list-group-item-action"
               aria-current="true" style="background-color: aquamarine">
